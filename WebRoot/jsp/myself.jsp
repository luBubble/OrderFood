...
%>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse">
				...
				%>
					...
					<li><a href="#about" class="smoothScroll">我的信息</a></li>
				<% 
				}
				else
				{
					%>
					<li><a href="#about" class="smoothScroll">订单管理</a></li>
					<li><a href="#about" class="smoothScroll">我的商店</a></li>
					<%
				}
				%>
	...
	<!-- end navigation -->
<div class="article">
	<h2 class="text-uppercase text-center">用户信息</h2>
	<hr>
	<div class="base-mesg"> 
	...
	<div class="foods-list">
		<ul class="foods-ul">
			<p>菜单</p>
			<button class="form-control food-add">增加菜品</button>
			<%
			}
			%>
			<hr style="width: 100%; "/>
	...
	<script src="/OrderFood/js/myself.js" ></script>
