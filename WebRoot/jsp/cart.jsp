...
%>
	<div class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="container">
			...
			<div class="collapse navbar-collapse">
				...
				{
				%>
					<li><a href="#about" class="smoothScroll">购物车</a></li>
	...
	<div class="foods-list">
		<ul >
			<h2 class="text-uppercase text-center">我的购物车</h2>
			<hr>
		...
		<div class="prices">总计：￥44<span class="tatal"></span></div>
		...
		<div class="order-button">
				<button class="form-control creat-order">生成订单</button><br/>
				<button class="form-control cancel">取消</button>
		</div>
	...
	<script src="/OrderFood/js/cart.js" type="text/javascript"></script>
